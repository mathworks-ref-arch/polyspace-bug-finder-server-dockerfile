...
docker build . -t polyspace-bug-finder-server:r2026a
```
...
polyspace-bug-finder-server:r2026a   e2dba34fb2c3       4.95GB             0B
```
...
-v "$(pwd):/work" polyspace-bug-finder-server:r2026a \ 
...
|---|---|---|
| MATLAB_RELEASE | r2026a | The Polyspace Server release you want to install. Must be lower-case, for example: `r2024b`.|
...
docker build -t polyspace-bug-finder-server:r2026a --build-arg LICENSE_SERVER=27000@MyServerName.example.com .
...
```bash
docker image rm polyspace-bug-finder-server:r2026a
```
...
Copyright (c) 2022-2026 The MathWorks, Inc. All rights reserved.
